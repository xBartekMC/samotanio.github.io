<?php
    ...
    ?>
        <script>
        window.alert("Brak rzeczy w koszyku!!");
        </script>
    <?php
    }else{
        ...
        <div>
            ...
            <div class="container">
                <table class="table table-bordered table-striped">
                    <tbody>
                        <tr>
                            <th>Numer</th><th>Nazwa</th><th>Koszt</th><th></th>
                        </tr>
                       <?php 
                        $user_products_result=mysqli_query($con,$user_products_query) or die(mysqli_error($con));
                        $no_of_user_products= mysqli_num_rows($user_products_result);
                       ...
                       while($row=mysqli_fetch_array($user_products_result)){
                        ...
                        <tr>
                            ...
                            <th><a href='cart_remove.php?id=<?php echo $row['id'] ?>'>Usuń</a></th>
                        </tr>
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Ogólny</th><th>Koszt <?php echo $sum;?>/-</th><th><a href="https://tipanddonation.com/xBartekTM/" class="btn btn-primary">Potwierdź</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
